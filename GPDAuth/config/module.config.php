...
return [
    ...
    AuthConfig::AUTH_METHOD_KEY => getenv("GPDAUTH_CONFIG__AUTH_METHOD_KEY") ? AuthMethod::tryFromString(getenv("GPDAUTH_CONFIG__AUTH_METHOD_KEY")) ?? AuthMethod::SessionOrJwt : AuthMethod::SessionOrJwt, // Tiempo en segundos
